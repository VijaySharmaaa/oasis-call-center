      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-zinc-500 mt-0.5">
            {total} {isFiltered ? "filtered" : "total"} tickets · auto-refreshes
            every 5s
          </p>
        </div>
        <button
      ...
      {loading && tickets.length === 0 ? (
        ...
        <div className="text-center py-20 text-slate-400 dark:text-zinc-500">
          ...
          <p className="text-sm mt-1">
            Create a ticket from the Call Report page.
          </p>
        </div>
      ) : (
        <>
              ...
              <tbody>
                {tickets.map((t) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-2.5 text-slate-500 dark:text-zinc-400 tabular-nums">
                      {t.customer_number}
                    </td>
                    <td className="px-3 py-2.5 text-slate-900 dark:text-zinc-100 font-medium max-w-[220px] truncate">
                      {t.title}
                    </td>
                    <td className="px-3 py-2.5 text-slate-500 dark:text-zinc-400 text-xs whitespace-nowrap">
                      {t.category}
                    </td>
                    ...
                    <td className="px-3 py-2.5">
                      <Badge
                        text={t.priority}
                        style={PRIORITY_STYLE[t.priority] ?? ""}
                      />
                    </td>
                    <td className="px-3 py-2.5">
                      <Badge
                    ...
                    <td className="px-3 py-2.5 text-slate-400 dark:text-zinc-500 text-xs whitespace-nowrap">
